...
$resultDoenca = $mysqli->query("SELECT tbAnimal.nomeAnimal as 'animal', tbDoenca.tipoDoenca as 'doenca' FROM tbAnimal INNER JOIN tbDoenca ON tbAnimal.idVacina = tbDoenca.idDoenca WHERE tbAnimal.idAnimal = '$pet_data[idAnimal]'") or die($mysqli->error);

$doenca_data = mysqli_fetch_assoc($resultDoenca);

$fotoOng = $mysqli->query("SELECT tbAnimal.nomeAnimal as 'animal', tbOng.fotoOng as 'fotoOng' FROM tbAnimal INNER JOIN tbOng ON tbAnimal.idAnimal = tbOng.idOng  WHERE tbAnimal.idAnimal = '$pet_data[idAnimal]'");
