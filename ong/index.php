    ...
    <div class="forms-container">
      <div class="signin-signup">
        ...
        <form action="./Cadastro/cadastro.php" enctype="multipart/form-data" method="POST" class="sign-up-form">
          <img class="fundo-enfeite-laranja" src="images/bolinha-fundo1.png" alt="">
          ...
          <div class="area-form">
            ...
            <div id="area-dados">
              ...
              <div class="input-laranja1">
                ...
                <input type="capacidade" placeholder="Capacidade" required name="capacidade" />
              </div>
              ...
              <div class="btn-avancar">
                <button><i class="fi fi-br-angle-small-right"></i></button>
              </div>
            </div>
              ...
              <div class="area-campos">
                ...
                <div class="botoes">
                  <div class="btn-voltar">
                    <button><i class="fi fi-br-angle-small-left"></i></button>
                  </div>
                  <div class="area-btn">
