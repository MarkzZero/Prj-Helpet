            ...
            <div class="main">
                ...
                <section class="table__header">
                    <div class="sub-titulo">
                        <span>Anunciantes Cadastrados</span>
                    </div>

                    <div class="input-group">
                        <input id="searchbar" onkeyup="search_animal()" type="search"   placeholder="Pesquisar nome do anunciante...">
                ...
                <?php while($user_data = mysqli_fetch_assoc($result)){ ?>
                    ...
                    <div class="card">
                        ...
                        <div class="btns">
                            <button class="btn-info open-modalAnun">
                                <p>Ver Mais</p>
                                <i class="fi fi-br-angle-small-right"></i>
                            </button>
                            <button class="btn-delete open-modalExcAnun"><i class="fi fi-sr-trash"></i></button>
                        </div>

                        <div class="fadeAnun hide"></div>
                        <div class="modalAnun hide">
                            <div class="modal-header">
                                <div class="detalhe-modal">
                                    <img src="images/pag-ongs.png" alt="">
                                </div>
                                <i class="fi fi-br-cross close-modalUser"></i>
                            </div>
                        ...
                        <div class="fadeExcAnun hide"></div>
                        <div class="modalExcAnun hide">
                            <div class="modal-headerExcluir">
                                <i class="fi fi-br-cross close-modalExcAnun"></i>
                            </div>
                            ...
                            <div class="area-modalExcluir">
                                ...
                                <div class="excluir-info">
                                    <span>Deseja excluir o perfil do Anunciante <?php echo $user_data['nomeOng'];?> permanentemente?</span>
                                </div>
