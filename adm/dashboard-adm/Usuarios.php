            ...
            <div class="main">
                ...
                <section class="table__header">
                    ...
                    <div class="input-group">
                        <input id="searchbar" onkeyup="search_animal()" type="search"  placeholder="Pesquisar nome do usuário...">
                ...
                <?php while($user_data = mysqli_fetch_assoc($resultUsuario)){ ?>
                    ...
                    <div class="card">
                        ...
                        <div class="fadeExcUser hide"></div>
                        <div class="modalExcUser hide">
                            <div class="modal-headerExcluir">
                                <i class="fi fi-br-cross close-modalExcUser"></i>
                            </div>
                            ...
                            <div class="area-modalExcluir">
                                ...
                                <div class="excluir-info">
                                    <span>Deseja excluir o perfil do Usuário <?php echo $user_data['nomeOng'];?> permanentemente?</span>
                                </div>
