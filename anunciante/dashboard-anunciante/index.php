            ...
            <div id="area-cards" class="area-cards">
                ...
                <div class="card">
                    ...
                    <div class="modalEdit hide">
                        ...
                        <form action="cadastro/editarAnuncio.php" method="POST" enctype="multipart/form-data">
                            <div class="modal-conteudo">
                                <div class="adicionar-fotos">
                                    <div class="imageContainer">
                                        <img src="<?php echo "cadastro/" . $user_data['fotoAnuncio'];?>" alt="selecionar foto" id="imgPhoto">
                                        <input type="file" id="flImage" name="image" accept="image/*">
                                        <p class="titulo-foto">Foto do Anúncio</p>
                                    </div>
                                ...
                                <div class="campos-anuncio">
                                    <div class="campo">
                                        <input type="text" placeholder="Nome do Anúncio" require name="nome" value="<?php echo $user_data['nomeAnuncio'];?>"/>
                                    </div>
